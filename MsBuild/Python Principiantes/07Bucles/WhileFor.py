#Ask the user to insert numbers or insert the key word "done" to finish. All the numbers must be stored in a list, that has to be displayed at the end, in a column.
